...
INSERT INTO `import_export` (`id`, `name`, `description`, `quantity`, `price`, `created_at`) VALUES
(1, 'AA', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(2, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(3, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(4, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(5, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(6, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(7, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(8, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(9, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(10, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(11, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(12, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(13, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(14, 'BB', 'some desc', 11, 777.00, '2025-05-21 04:54:42'),
(15, 'CC', 'some desc', 12, 888.00, '2025-05-21 04:54:42');
...
INSERT INTO `participents` (`id`, `name`, `amount`) VALUES
(1, 'Alice', 650.00),
(2, 'Bob', 200.00),
(3, 'Charlie', 350.00),
(4, 'Diana', 250.00),
...
(1, 101, 201, 180000.00, '2025-05-21 09:45:50'),
(2, 101, 301, 5000000.00, '2025-05-21 09:48:52');
...
INSERT INTO `transactions_log` (`id`, `from_id`, `to_id`, `amount`, `date`) VALUES
(3, 2, 1, 50.00, '2025-05-21 10:24:44'),
(4, 3, 2, 50.00, '2025-05-21 10:25:00');
...
CREATE TABLE `trunks` (
  ...
  `participents_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `trunks` (`id`, `productname`, `participents_id`) VALUES
(1, 'Laptop', 3),
(2, 'Smartphone', 2),
(3, 'Tablet', 3),
(4, 'Headphones', 4),
...
ALTER TABLE `trunks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `participents_id` (`participents_id`);
...
--
ALTER TABLE `trunks`
  ADD CONSTRAINT `trunks_ibfk_1` FOREIGN KEY (`participents_id`) REFERENCES `participents` (`id`);
COMMIT;
