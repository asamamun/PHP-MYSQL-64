...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array()</span> - Creates an array (alternative syntax: <span class="text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">[]</span>).</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_combine()</span> - Creates an array by using one array for keys and another for values.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_fill()</span> - Fills an array with a specified value.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_keys()</span> - Returns all the keys or a subset of keys from an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_values()</span> - Returns all the values of an array as a new indexed array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">range()</span> - Creates an array containing a range of elements (e.g., numbers or letters).</li>
</ul>
<h3 dir="auto" class=""><a href="images/Array Modification.png">Array Modification</a></h3>
<ul dir="auto" class="marker:text-secondary">
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_push()</span> - Adds one or more elements to the end of an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_pop()</span> - Removes and returns the last element of an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_shift()</span> - Removes and returns the first element of an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_unshift()</span> - Adds one or more elements to the beginning of an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_splice()</span> - Removes a portion of the array and replaces it with something else.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_pad()</span> - Pads an array to a specified length with a value.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_reverse()</span> - Returns an array with elements in reverse order.</li>
...
<ul dir="auto" class="marker:text-secondary">
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">sort()</span> - Sorts an array in ascending order.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">rsort()</span> - Sorts an array in descending order.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">asort()</span> - Sorts an array in ascending order, maintaining key association.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">arsort()</span> - Sorts an array in descending order, maintaining key association.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">ksort()</span> - Sorts an array by key in ascending order.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">krsort()</span> - Sorts an array by key in descending order.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">natsort()</span> - Sorts an array using a "natural order" algorithm.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">natcasesort()</span> - Case-insensitive "natural order" sort.</li>
...
<ul dir="auto" class="marker:text-secondary">
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">in_array()</span> - Checks if a value exists in an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_search()</span> - Searches the array for a value and returns the corresponding key.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_key_exists()</span> - Checks if a specified key exists in an array (alias: <span class="text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">key_exists()</span>).</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_filter()</span> - Filters elements of an array using a callback function.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_unique()</span> - Removes duplicate values from an array.</li>
...
<ul dir="auto" class="marker:text-secondary">
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_map()</span> - Applies a callback to the elements of one or more arrays.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_reduce()</span> - Iteratively reduces the array to a single value using a callback.</li>
</ul>
<h3 dir="auto" class=""><a href="images/Array Information.png">Array Information</a></h3>
<ul dir="auto" class="marker:text-secondary">
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">count()</span> - Counts the number of elements in an array (alias: <span class="text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">sizeof()</span>).</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_count_values()</span> - Counts the frequency of each value in an array.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_rand()</span> - Picks one or more random keys from an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_sum()</span> - Calculates the sum of values in an array.</li>
...
<ul dir="auto" class="marker:text-secondary">
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_merge()</span> - Merges one or more arrays.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_replace()</span> - Replaces elements from one array into another.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">array_slice()</span> - Extracts a slice of an array.</li>
</ul>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">extract()</span> - Imports variables into the current symbol table from an array.</li>
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">compact()</span> - Creates an array containing variables and their values.</li>
...
<li class="break-words"><span class="im text-sm px-1 rounded-sm !font-mono bg-sunset/10 text-rust dark:bg-dawn/10 dark:text-dawn">list()</span> - Assigns variables as if they were an array (not strictly an array function but commonly used with arrays).</li>
</ul>
